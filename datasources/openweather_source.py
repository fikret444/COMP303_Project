...
class OpenWeatherSource(DataSource):
        ...
        try:
            ...
            if self.include_forecast:
                try:
                    ...
                    # Even if the forecast is not returned still return current
                    pass
    ...
    def parse(self, raw):
        current_data = raw.get("current", raw)
        ...
        # Parsing and adding forecast data
        if forecast_data and forecast_data.get("list"):
            for item in forecast_data.get("list", []):
                ...
                # forming timestamp to datestamp
                ...
                result.append(forecast_weather)
