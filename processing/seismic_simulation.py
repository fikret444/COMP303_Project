# Deprem simülasyonu ve erken uyarı sistemi
...
def generate_random_epicenter(user_lat, user_lon):
    ...
    min_distance_from_sensor = 200
    max_distance_from_sensor = 800
